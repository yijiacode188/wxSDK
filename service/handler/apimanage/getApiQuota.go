...
import (
	"errors"
	"github.com/yijiacode188/wxSDK/service/handler/apimanage/dto"
	"github.com/yijiacode188/wxSDK/service/handler/apimanage/vo"
...
func (apiManager *ApiManager) GetApiQuota(body *dto.GetApiQuotaRequest) (*vo.GetApiQuotaResponse, *utils.Response, error) {
