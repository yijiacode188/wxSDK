...
func (wx *wxClient) GetCode2Session(code string) (*vo.GetCode2SessionResponse, error) {
	params := make(url.Values)
	params.Add("appid", wx.AppId)
	params.Add("secret", wx.Secret)
	params.Add("js_code", code)
	params.Add("grant_type", "authorization_code")
	result, _, err := utils.HttpGet[vo.GetCode2SessionResponse](&utils.RequestParams{
