...
import (
	...
	"github.com/yijiacode188/wxSDK/subscription/handler/materialPermanent/vo"
...
func (wx *MaterialPermanent) UploadImage(fileHeader *multipart.FileHeader) (string, *utils.Response, error) {
