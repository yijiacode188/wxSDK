...
import (
	...
	"errors"
	"fmt"
	"github.com/yijiacode188/wxSDK/subscription/handler/materialTemporary/vo"
...
// 本接口用于上传临时多媒体文件
// https://developers.weixin.qq.com/doc/service/api/material/temporary/api_uploadtempmedia.html
func (wx *MaterialTemporary) UploadTempMedia(fileHeader *multipart.FileHeader, mediaType MediaType) (*vo.UploadTempMediaResponse, *utils.Response, error) {
	...
	result, response, err := utils.HttpPost[vo.UploadTempMediaResponse](&utils.RequestParams{
