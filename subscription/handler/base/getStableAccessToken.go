...
import (
	"errors"
	"github.com/yijiacode188/wxSDK/subscription/handler/base/dto"
	"github.com/yijiacode188/wxSDK/subscription/handler/base/vo"
...
func (base *Base) GetStableAccessToken(forceRefresh bool) (string, *utils.Response, error) {
