...
func (wx *wxClient) GetApiQuota(body *dto.GetApiQuotaRequest) (*vo.GetApiQuotaResponse, error) {
	...
	result, _, err := utils.HttpPost[vo.GetApiQuotaResponse](&utils.RequestParams{
