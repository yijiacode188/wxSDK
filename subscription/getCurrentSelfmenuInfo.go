...
func (wx *wxClient) GetCurrentSelfMenuInfo() (*vo.GetCurrentSelfMenuInfoResponse, error) {
	...
	result, _, err := utils.HttpGet[vo.GetCurrentSelfMenuInfoResponse](&utils.RequestParams{
